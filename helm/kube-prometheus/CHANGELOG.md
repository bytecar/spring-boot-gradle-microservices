...
* [bitnami/kube-prometheus] Release 8.25.7 updating components versions (
...
* [bitnami/kube-prometheus] prometheus-operator use podLabels helper (
...
* bitnami/kube-prometheus fix: cluster role promagent needs to be plural (
...
* [bitnami/kube-prometheus] Allow setting global scrapeTimeout (
...
* [bitnami/kube-prometheus] Release 8.10.2 (
...
* [bitnami/kube-prometheus] Fix - non consistent nindent on alertmanager templates (
...
* [bitnami/kube-prometheus] Release 8.0.6 updating components
...
* [bitnami/kube-prometheus] Standardize kube-prometheus (
...
* [bitnami/kube-prometheus] Release 6.2.1 updating components
...
* [bitnami/*] Adapt values.yaml of Kong, kube-prometheus and kube-state-metrics charts (
  #6866) ([91fe898](https://github.com/bitnami/charts/commit/91fe89837f06c12c9f76e72aafac26248fac2177)),
  closes [#6866](https://github.com/bitnami/charts/issues/6866)

## 6.1.0 (2021-06-30)

* Allow to specify probe paths in the kube-prometheus chart (#6780) (
  #6781) ([d91935c](https://github.com/bitnami/charts/commit/d91935cdc0f274515145fe01d675953ac5a14c9c)),
  closes [#6780](https://github.com/bitnami/charts/issues/6780) [#6781](https://github.com/bitnami/charts/issues/6781)

## <small>6.0.1 (2021-06-21)</small>

* [bitnami/kube-prometheus] Added missing upgradePath documentation (
  #6633) ([9c2f260](https://github.com/bitnami/charts/commit/9c2f260a373b7d389c56d87e053de20811e0b51d)),
  closes [#6633](https://github.com/bitnami/charts/issues/6633)
* [bitnami/kube-prometheus] Release 6.0.1 updating components
  versions ([254b154](https://github.com/bitnami/charts/commit/254b15430b143a7eba01d34d00db279a4c845fa1))

## 6.0.0 (2021-06-07)

* [bitnami/kube-prometheus] Added support for containerSecurityContext until it gets fixed
  upstream. ( ([c6c4ae6](https://github.com/bitnami/charts/commit/c6c4ae6777cbee9c29daeb629b853e6532507135)),
  closes [#6461](https://github.com/bitnami/charts/issues/6461)

## <small>5.0.4 (2021-06-02)</small>

* [bitnami/kube-prometheus] Release 5.0.4 updating components
  versions ([182163d](https://github.com/bitnami/charts/commit/182163d3302f93bdf5fb14ad2b18db1c31282b77))

## <small>5.0.3 (2021-05-27)</small>

* [bitnami/kube-prometheus] Release 5.0.3 updating components
  versions ([97fa3c8](https://github.com/bitnami/charts/commit/97fa3c84f4736e4e37cf42a101be34978a1df0c6))

## <small>5.0.2 (2021-05-24)</small>

* [bitnami/kube-prometheus] Fix indentation of command line arguments (
  #6440) ([50fa206](https://github.com/bitnami/charts/commit/50fa206e84e20b2e477c5ec1603efd5114bc2570)),
  closes [#6440](https://github.com/bitnami/charts/issues/6440)
* [bitnami/kube-prometheus] Force new release (
  #6450) ([de3189a](https://github.com/bitnami/charts/commit/de3189ae0cb619d8e33fc1583fc52ce552323fbf)),
  closes [#6450](https://github.com/bitnami/charts/issues/6450)

## <small>5.0.1 (2021-05-23)</small>

* [bitnami/*] Update wavefront used as subchart to newest major (
  #6417) ([365851a](https://github.com/bitnami/charts/commit/365851aeabfd1caee24b0d007969f03738b06160)),
  closes [#6417](https://github.com/bitnami/charts/issues/6417)
* [bitnami/kube-prometheus] Release 5.0.1 updating components
  versions ([7bdf67c](https://github.com/bitnami/charts/commit/7bdf67c3acbee13b9bb194687b7dc41479b4669b))

## 5.0.0 (2021-05-11)

* [bitnami/*] Update kube-state-metrics used as subchart to newest major (
  #6324) ([d3255c1](https://github.com/bitnami/charts/commit/d3255c1f33650f141cd6d8c183ff4de16152edbd)),
  closes [#6324](https://github.com/bitnami/charts/issues/6324)

## 4.4.0 (2021-05-10)

* [bitnami/kube-prometheus] Use new cmdline options for config-reloader resources (
  #6318) ([0a95c90](https://github.com/bitnami/charts/commit/0a95c90db521d41a039201d3a08055e10f60a2d8)),
  closes [#6318](https://github.com/bitnami/charts/issues/6318)

## <small>4.3.1 (2021-04-30)</small>

* [bitnami/kube-prometheus] Release 4.3.1 updating components
  versions ([69e0375](https://github.com/bitnami/charts/commit/69e0375b5ce2bad2452ee6e2d8e579bea932dc67))

## 4.3.0 (2021-04-30)

* [bitnami/kube-prometheus] Add support for `AlertmanagerConfig` CRD (
  #6257) ([941fd47](https://github.com/bitnami/charts/commit/941fd471fd3ab83baca39eaf16095d79d7d9a063)),
  closes [#6257](https://github.com/bitnami/charts/issues/6257)

## <small>4.2.2 (2021-04-14)</small>

* [bitnami/kube-prometheus] Release 4.2.2 updating components
  versions ([ae93af5](https://github.com/bitnami/charts/commit/ae93af52d25fa785a62932d0f8ed2ec552e0bc06))

## <small>4.2.1 (2021-03-26)</small>

* [bitnami/kube-prometheus] Release 4.2.1 updating components
  versions ([dd97053](https://github.com/bitnami/charts/commit/dd97053e3a7e064fd9166d037c5f520236640610))

## 4.2.0 (2021-03-17)

* [bitnami/kube-prometheus] Allow custom prometheus url in Thanos sidecar (
  #5798) ([f92b9b5](https://github.com/bitnami/charts/commit/f92b9b5eddffa54c0cf242d247d7915ddb08a5b0)),
  closes [#5798](https://github.com/bitnami/charts/issues/5798)
* [bitnami/kube-prometheus] Update crds kube prometheus (
  #5639) ([c733816](https://github.com/bitnami/charts/commit/c7338163815b5461e22487582720964d31545543)),
  closes [#5639](https://github.com/bitnami/charts/issues/5639)

## <small>4.1.2 (2021-03-02)</small>

* Add possibility to pull images without giving registry name (
  #5638) ([6701f61](https://github.com/bitnami/charts/commit/6701f61b79078b25755cb443b2633736349cbdfc)),
  closes [#5638](https://github.com/bitnami/charts/issues/5638)

## <small>4.1.1 (2021-02-24)</small>

* [bitnami/kube-prometheus] Release 4.1.1 updating components
  versions ([b3bbf87](https://github.com/bitnami/charts/commit/b3bbf878b563c473a6a994ec61a2665634817073))

## 4.1.0 (2021-02-23)

* [bitnami/kube-prometheus] Added `routePrefix` and `portName` to `alertmanager` and `prometheus` (
  #55 ([2c8aea7](https://github.com/bitnami/charts/commit/2c8aea703b735ec9abae46bb1fe3bf70151b6720)),
  closes [#5573](https://github.com/bitnami/charts/issues/5573)
...
* fix(kube-prometheus): alertmanager ingress extraTls (
  #5427) ([516352b](https://github.com/bitnami/charts/commit/516352bd4eda86e6d53c4f80ef543cdf1e2e1929)),
  closes [#5427](https://github.com/bitnami/charts/issues/5427)

## 4.0.0 (2021-02-02)

* [bitnami/kube-prometheus] Fix ingress ApiVersion v1 (
  #5338) ([26f7b64](https://github.com/bitnami/charts/commit/26f7b648626a92f47b9baca1b6dae4eb521dfacf)),
  closes [#5338](https://github.com/bitnami/charts/issues/5338)

## 3.7.0 (2021-02-01)

* [bitnami/kube-prometheus] Add ingress for thanos sidecar (
  #5345) ([22543f5](https://github.com/bitnami/charts/commit/22543f5dca5b5953141f0ee5867a38c837223936)),
  closes [#5345](https://github.com/bitnami/charts/issues/5345)

## <small>3.6.1 (2021-02-01)</small>

* [bitnami/kube-prometheus] Removed invalid character from values.yaml (
  #5341) ([22cb126](https://github.com/bitnami/charts/commit/22cb1262b00eaac53d6d67bb347330ca40b98988)),
  closes [#5341](https://github.com/bitnami/charts/issues/5341)

## 3.6.0 (2021-01-28)

* [bitnami/kube-prometheus] Add hostAliases (
  #5253) ([f7ad6f7](https://github.com/bitnami/charts/commit/f7ad6f7684a87d413fe71a6b46716e8442e6df12)),
  closes [#5253](https://github.com/bitnami/charts/issues/5253)

## 3.5.0 (2021-01-24)

* [bitnami/kube-prometheus] Deprecate ConfigMap Reload (
  #5149) ([29bcae9](https://github.com/bitnami/charts/commit/29bcae94ce823c4b9f7dfce3161d74b1548a201c)),
  closes [#5149](https://github.com/bitnami/charts/issues/5149)
...
* [bitnami/kube-prometheus] Drop values-production.yaml support (
  #5111) ([1c8030e](https://github.com/bitnami/charts/commit/1c8030e5459c9d966a4d5d103dff3243d6a9a0f8)),
  closes [#5111](https://github.com/bitnami/charts/issues/5111)

## <small>3.4.1 (2021-01-18)</small>

* [bitnami/kube-prometheus] Bug fix. Remove whitespace chomping in new secret (
  #5055) ([46d38c9](https://github.com/bitnami/charts/commit/46d38c92e23aedc12c179f86feb23cb30f0f5ae8)),
  closes [#5055](https://github.com/bitnami/charts/issues/5055)

## 3.4.0 (2021-01-14)

* [bitnami/kube-prometheus] Add internal chart management of additional scrape configs (
  #4975) ([962b4e9](https://github.com/bitnami/charts/commit/962b4e9be32311eb31779a44cae18f5895456c4a)),
  closes [#4975](https://github.com/bitnami/charts/issues/4975)
...
* [bitnami/kube-prometheus] Release 3.3.3 updating components
  versions ([bc4b609](https://github.com/bitnami/charts/commit/bc4b6097be9ed2c6f4b25441d9f7954d05d17440))
...
* [bitnami/kube-prometheus] Release 3.3.1 updating components
  versions ([59e9529](https://github.com/bitnami/charts/commit/59e9529e24261113945e9dd7e3d60c88ad48b083))

## 3.3.0 (2020-12-08)

* [bitnami/kube-prometheus] Added externalTrafficPolicy and healthCheckNodePort for services (
  #4625) ([3e3a9e7](https://github.com/bitnami/charts/commit/3e3a9e742cb9fb5a6251abc3d37427a29e40a89a)),
  closes [#4625](https://github.com/bitnami/charts/issues/4625)

## 3.2.0 (2020-12-04)

* [bitnami/kube-prometheus] Update chart to work with v0.44 (
  #4613) ([d06e73d](https://github.com/bitnami/charts/commit/d06e73d8a94a383aa5c02a4ebea8b9ea99e53219)),
  closes [#4613](https://github.com/bitnami/charts/issues/4613)
* add support for chart labels to exporters (
  #4589) ([02137aa](https://github.com/bitnami/charts/commit/02137aa5b64da3460fbca80ea63569248989088d)),
  closes [#4589](https://github.com/bitnami/charts/issues/4589)
...
* [bitnami/kube-prometheus] Fix typo in prometheus.yaml (
  #4489) ([59b4f5d](https://github.com/bitnami/charts/commit/59b4f5d7a2a7a5ad463471df95874be6f36a6bef)),
  closes [#4489](https://github.com/bitnami/charts/issues/4489)

## 3.1.0 (2020-11-25)

* [bitnami/*] Affinity based on common presets (iii) (
  #4476) ([196d096](https://github.com/bitnami/charts/commit/196d0963494b4104b0e66a67b0c5cf899beca06b)),
  closes [#4476](https://github.com/bitnami/charts/issues/4476)

## <small>3.0.1 (2020-11-16)</small>

* [bitnami/kube-prometheus] Update CRDs and ClusterRole (
  #4235) ([0f40d3c](https://github.com/bitnami/charts/commit/0f40d3cd78a73c8b4a6dec04c07a06ad21911626)),
  closes [#4235](https://github.com/bitnami/charts/issues/4235)

## 3.0.0 (2020-11-12)

* [bitnami/kube-prometheus] Major version. Adapt Chart to apiVersion: v2 (
  #4326) ([515c5ce](https://github.com/bitnami/charts/commit/515c5ceb243bbeb8a096c1af2334b682902cef7b)),
  closes [#4326](https://github.com/bitnami/charts/issues/4326)

## <small>2.2.4 (2020-11-09)</small>

* [bitnami/kube-prometheus] Release 2.2.4 updating components
  versions ([f45c195](https://github.com/bitnami/charts/commit/f45c19558fa4b4a63e68474e9cf1b3a90c2fd95c))
...
* [bitnami/kube-prometheus] Release 2.2.3 updating components
  versions ([f7317c8](https://github.com/bitnami/charts/commit/f7317c846cdaf30a0827988ef32e8e2d8194eedd))

## <small>2.2.2 (2020-10-22)</small>

* [bitnami/kube-prometheus] Release 2.2.2 updating components
  versions ([10bf856](https://github.com/bitnami/charts/commit/10bf8567c3a2cab8a5e8151e338df6f05f1c20bc))

## <small>2.2.1 (2020-10-01)</small>

* Pull container references into a configmap for easier overriding. (
  #3517) ([c261c1d](https://github.com/bitnami/charts/commit/c261c1d9739ad36765603918782fcad8750ba89c)),
  closes [#3517](https://github.com/bitnami/charts/issues/3517)

## 2.2.0 (2020-09-28)

* [bitnami/kube-prometheus] Set of exporters updated (
  #3727) ([f71bb28](https://github.com/bitnami/charts/commit/f71bb28343be8a3ad1aaaaee1730616314d57b3e)),
  closes [#3727](https://github.com/bitnami/charts/issues/3727)

## <small>2.1.1 (2020-09-24)</small>

* [bitnami/kube-prometheus] Fix _helpers.tpl to take into account global.labels option (
  #3765) ([ec44052](https://github.com/bitnami/charts/commit/ec4405267c0d14d6d6473d51f901bbca24a080fb)),
  closes [#3765](https://github.com/bitnami/charts/issues/3765)

## 2.1.0 (2020-09-23)

* [bitnami/kube-prometheus] Use headless svc for Thanos sidecars svc by default (
  #3725) ([533d1f2](https://github.com/bitnami/charts/commit/533d1f27b3a58b08eea2db8bc9ed96b6d67f41ff)),
  closes [#3725](https://github.com/bitnami/charts/issues/3725)

## <small>2.0.1 (2020-09-22)</small>

* [bitnami/kube-prometheus] Release 2.0.1 updating components
  versions ([d052d55](https://github.com/bitnami/charts/commit/d052d552f70a9e1d533f2d2312d13943c738266f))

## 2.0.0 (2020-09-07)

* [bitnami/kube-prometheus] install prometheus v0.4.1 crds (
  #3597) ([75da3d6](https://github.com/bitnami/charts/commit/75da3d6252c6d772d12b51575a0b9541e6197fe1)),
  closes [#3597](https://github.com/bitnami/charts/issues/3597)
...
* [bitnami/kube-prometheus] Allow override of prometheus.routePrefix (
  #3567) ([8c1ead6](https://github.com/bitnami/charts/commit/8c1ead6741af4cddf20b1ab2a9cbcbb1709e0ffa)),
  closes [#3567](https://github.com/bitnami/charts/issues/3567)

## <small>1.0.2 (2020-08-31)</small>

* [kube-prometheus] Set Prometheus Operator container name to 'prometheus-operator' (
  #3561) ([3849862](https://github.com/bitnami/charts/commit/384986289c3866a2d355acf627f46a734cebe316)),
  closes [#3561](https://github.com/bitnami/charts/issues/3561)

## <small>1.0.1 (2020-08-28)</small>

* [bitnami/kube-prometheus] Release 1.0.1 updating components
  versions ([70b62d0](https://github.com/bitnami/charts/commit/70b62d0a871a6aa59a10928632743311e22d002b))
* Fix installation with long
  names ([c5cf438](https://github.com/bitnami/charts/commit/c5cf438116301f26f512faa9be1d9315123da2ed))

## 1.0.0 (2020-08-28)

* [bitnami/prometheus-operator] New major version + renaming (
  #3498) ([d0045d9](https://github.com/bitnami/charts/commit/d0045d9f223ec6b81145e9901a170f281cb9e0e9)),
  closes [#3498](https://github.com/bitnami/charts/issues/3498)
